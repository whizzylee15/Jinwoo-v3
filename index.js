    ...
    if (connection === 'close') {
        ...
        if (initialConnection) {
            ...
            Matrix.sendMessage(Matrix.user.id, { 
                ...
                caption: `*Hello there JINWOO-MD User! 👋🏻* 

> Simple, Straightforward, But Loaded With Features 🎊. Meet JINWOO-MD V3 WhatsApp Bot.

*Thanks for using JINWOO-MD V3🚩* 
